...
class Renamed(Scraper):
    ...
    def getmodules(cls):
        return (
            ...
            cls('Katbox/Paprika', 'KemonoCafe/Paprika'),
            cls('Katbox/PeterAndCompany', 'PeterAndCompany'),
            cls('Katbox/PeterAndWhitney', 'PeterAndWhitney'),
            cls('Katbox/PracticeMakesPerfect', 'KemonoCafe/PracticeMakesPerfect'),
            cls('Katbox/Rascals', 'KemonoCafe/Rascals'),
            cls('Katbox/TheEyeOfRamalach', 'KemonoCafe/TheEyeOfRamalach'),
