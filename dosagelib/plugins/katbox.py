...
class Katbox(_ParserScraper):
    ...
    def getmodules(cls):
        return (
            ...
            cls('LasLindas/BreastsAreTheBest', 'laslindas', 'breasts-are-the-best', 'breasts-are-the-best-1', last='breasts-are-the-best-60', adult=True),
...
class KatboxImageDump(_ParserScraper):
    ...
    def getmodules(cls):
        return (
            cls('LasLindas/BuildingAnEmpire', 'laslindas', 'cancelled-be'),
            cls('LasLindas/CrestDiaries', 'laslindas', 'cancelled-cd'),
            cls('LasLindas/DungeonsAndDames', 'laslindas', 'cancelled-dnd'),
            cls('LasLindas/DungeonsAndDames2', 'laslindas', 'cancelled-dnd2'),
            cls('LasLindas/LearningCurves', 'laslindas', 'cancelled-lc', adult=True),
        )
